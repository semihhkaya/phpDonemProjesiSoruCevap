<?php 
  ...
  $kelime= strip_tags(g("kelime"));

//sayfalamanın sorgusu
  ...
  $sayi->execute(["%".$kelime."%"]);
  fetch($sayi);
  $say = $sayi->rowcount(); //Arama ifadesini içeren Soru sayısını buluyoruz

  $limit = 2; //Her sayfada kaç soru gösterilecek
  ...
  //sayfada kaç soru gösterilecek. Listeleme
  ...
  if($kontrol){
    ...
    ?>
    <span class="d-block bg-success p-2 mb-3 text-white rounded-left">
      <span style="color:yellow"><?php echo $kelime;?></span> kelimesine ait (<?php echo $say;?>) sonuç bulundu.
    </span>
    <?php
    ...
    if($sayfa_sayisi > 1){
      ...
      <ul class="pagination justify-content-center mb-4">
            <li class="page-item">
              <a class="page-link" href="arama/<?php echo $kelime;?>/sayfa/<?php echo $onceki;?>">&larr; Geri </a>
            </li>
            <li class="page-item">
              <a class="page-link" href="arama/<?php echo $kelime;?>/sayfa/<?php echo $sonraki;?>">İleri &rarr;</a>
            </li>
          </ul>
      <?php
    }
